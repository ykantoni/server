                          ...
                          bool if_exists)
{
  ...
  */
  ...
  if (likely(!silent && !error))
  {
    ...
    /*
      Store xid in ddl log and binary log so that we can check on ddl recovery if
      the item is in the binary log (and thus the operation was complete
    */
             ...
             bool skip_error, bool if_exists)
{
  ...
  if (ha_check_if_updates_are_ignored(thd, param->from_table_hton, "RENAME"))
  {
    /*
